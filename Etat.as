...
//TODO: Temporairement, on accepte les événements de joueur déplace ici et la syncro du temps
    ...
    {nom:"ObtenirListeJoueursSalle", listeEvenementsAcceptables:new Array(), listeEvenementsAcceptablesAvant:new Array(), listeEvenementsAcceptablesApres:new Array("JoueurEntreSalle", "JoueurQuitteSalle")}), 
	listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDemarrePartie", "PartieDemarree", "JoueurDeplacePersonnage","SynchroniserTemps", "PartieTerminee", "UtiliserObjet")}; //Enlever le dernier

    
    
    // Constante objet indiquant que la partie du joueur a commencée
    public static var PARTIE_DEMARREE:Object = {no:10, listeCommandesPossibles:new Array({nom:"AcheterObjet", listeEvenementsAcceptables:new Array(), listeEvenementsAcceptablesAvant:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage", "SynchroniserTemps", "PartieTerminee","UtiliserObjet"), listeEvenementsAcceptablesApres:new Array()}, 
    ...
    {nom:"QuitterTable", listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite"), listeEvenementsAcceptablesAvant:new Array("JoueurDeplacePersonnage","SynchroniserTemps","UtiliserObjet"), listeEvenementsAcceptablesApres:new Array()},
	{nom:"RejoindrePartie", listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage","SynchroniserTemps", "PartieTerminee","UtiliserObjet"), listeEvenementsAcceptablesAvant:new Array(), listeEvenementsAcceptablesApres:new Array("UtiliserObjet", "SynchroniserTemps", "DeplacerPersonnage", "JoueurDeplacePersonnage", "PartieTerminee")}, 
    {nom:"DeplacerPersonnage", listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage","SynchroniserTemps", "PartieTerminee","UtiliserObjet"), listeEvenementsAcceptablesAvant:new Array("UtiliserObjet"), listeEvenementsAcceptablesApres:new Array("UtiliserObjet")}, 
    {nom:"Pointage", listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage","SynchroniserTemps", "PartieTerminee","UtiliserObjet"), listeEvenementsAcceptablesAvant:new Array("UtiliserObjet"), listeEvenementsAcceptablesApres:new Array("UtiliserObjet")}, 
    {nom:"Argent", listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage","SynchroniserTemps", "PartieTerminee","UtiliserObjet"), listeEvenementsAcceptablesAvant:new Array(), listeEvenementsAcceptablesApres:new Array()}), 
	listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage","SynchroniserTemps", "PartieTerminee", "UtiliserObjet", "DeplacementWinTheGame")};
    ...
    public static var ATTENTE_REPONSE_QUESTION:Object = {no:11, listeCommandesPossibles:new Array({nom:"Deconnexion", listeEvenementsAcceptables:new Array(), listeEvenementsAcceptablesAvant:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage", "SynchroniserTemps", "PartieTerminee"), listeEvenementsAcceptablesApres:new Array()},
	   ...
	   {nom:"RepondreQuestion", listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage", "SynchroniserTemps", "PartieTerminee","UtiliserObjet", "ReportBugQuestion"), listeEvenementsAcceptablesAvant:new Array("RejoindrePartie", "ReportBugQuestion"), listeEvenementsAcceptablesApres:new Array("JoueurDeplacePersonnage", "SynchroniserTemps", "PartieTerminee")},
	   {nom:"RejoindrePartie", listeEvenementsAcceptables:new Array("JoueurEntreSalle", "JoueurQuitteSalle", "JoueurEntreTable", "JoueurQuitteTable", "NouvelleTable", "TableDetruite", "JoueurDeplacePersonnage", "SynchroniserTemps", "PartieTerminee","UtiliserObjet", "ReportBugQuestion"), listeEvenementsAcceptablesAvant:new Array(), listeEvenementsAcceptablesApres:new Array("JoueurDeplacePersonnage", "SynchroniserTemps", "PartieTerminee")},
